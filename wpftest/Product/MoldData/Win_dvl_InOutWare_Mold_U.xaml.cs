...
namespace WizMes_ANT
{
    ...
    public partial class Win_dvl_InOutWare_Mold_U : UserControl
    {
        ...
        private void txtLotNoSrh_KeyDown(object sender, KeyEventArgs e)
        {
            if (e.Key == Key.Enter)
            {
                MainWindow.pf.ReturnCode(txtLotNoSrh, (int)Defind_CodeFind.DCF_MOLD, "");
            }
        }
            ...
            if (ExpExc.DialogResult.HasValue)
            {
                if (ExpExc.choice.Equals(dgdMoldInOut.Name))
                {
                    if (ExpExc.Check.Equals("Y"))
                        dt = Lib.Instance.DataGridToDTinHidden(dgdMoldInOut);
                    else
                        dt = Lib.Instance.DataGirdToDataTable(dgdMoldInOut);
        ...
        private void ControlVisibleAndEnable_AU()
        {
            ...
            dgdMoldInOut.IsHitTestVisible = false;
        ...
        private void ControlVisibleAndEnable_SC()
        {
            ...
            dgdMoldInOut.IsHitTestVisible = true;
        ...
        private void txtMoldNo_KeyDown(object sender, KeyEventArgs e)
        {
            if (e.Key == Key.Enter)
            {
                MainWindow.pf.ReturnCode(txtMoldNo, 51, "");
        ...
        private void re_Search(int selectIndex)
        {
            ...
            if (dgdMoldInOut.Items.Count > 0)
            {
                ...
                {
                    dgdMoldInOut.SelectedIndex = Lib.Instance.reTrunIndex(dgdMoldInOut, lstCompareValue[0]);
                }
                else
                {
                    ...
                    if (ds != null && ds.Tables.Count > 0)
                    {
                        ...
                        if (dt.Rows.Count > 0)
                        {
                            ...
                            foreach (DataRow dr in drc)
                            {
                                ...
                                dgdInOut_DTO.InOutDate = Lib.Instance.StrDateTimeBar(dgdInOut_DTO.InOutDate);
                                ...
                                dgdInOut_DTO.InOutQty = Lib.Instance.returnNumStringZero(dgdInOut_DTO.InOutQty);
        ...
        private bool dgdInsert()
        {
            ...
            if (CheckData())
            {
                try
                {
                    ...
                    sqlParameter.Add("InOutGbn", cboGubun.SelectedValue.ToString());
                    sqlParameter.Add("InOutQty", txtInOutQty.Text.Replace(",",""));
                    sqlParameter.Add("InOutDate", dtpDay.SelectedDate.Value.ToString("yyyyMMdd"));
                    sqlParameter.Add("InOutPlace", cboInOutPlace.SelectedValue.ToString());
